              ...
              <v-card color="grey darken-4">
                <v-container text-xs-center class="pb-0 mb-0">
                  <v-layout justify-center row wrap>
                    ...
                    <v-flex xs12 class="headline gold-text">9,428.00</v-flex>
                ...
                <v-card color="grey darken-4">
                  <v-container text-xs-center>
                    <v-layout justify-center row wrap>
                      ...
                      <v-flex xs6 class="gold-text py-0"><span class="display-1">123</span>.45</v-flex>
                      <v-flex xs6 class="gold-text py-0"><span class="display-1">20</span>.7%</v-flex>
                    </v-layout>
                  </v-container>
                </v-card>
              </v-flex>
